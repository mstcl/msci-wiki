...
def plot_mean_ori(file):
    ...
    fig.suptitle(r"$\alpha = {}$".format(file[25:30]))
    ax2.grid(alpha=.3)
...
```{python}
plot_mean_ori('../assets/dataset_tumble_0.023_0.25.h5')
plot_mean_ori('../assets/dataset_tumble_0.500_0.25.h5')
```
...
```{python}
label_cluster('../assets/dataset_tumble_0.023_0.25.h5')
label_cluster('../assets/dataset_tumble_0.500_0.25.h5')
```
